            ...
            <div className="container mx-auto px-6 relative z-10"> {/* z-10 ensures content is above particles */}
                        ...
                        <SwiperSlide key={project.id} className="h-full flex flex-col items-center justify-between">
                            ...
                            <div className="p-4 sm:p-6 rounded-lg flex-grow flex-col flex justify-center items-center">
                                <div className="mb-5 text-center relative backdrop-blur-[5px] p-2 rounded-md">
                                    ...
                                    <small
                                        className="block font-semibold text-sm sm:text-base text-gray-400 relative">
                                        {project.type}
                                    </small>
                                    ...
                                    <a
                                        ...
                                        className="bg-blue-500 text-white py-1 sm:py-2 px-3 sm:px-4 rounded-lg flex gap-2 hover:bg-blue-600"
                                    >
                ...
                {selectedProject && (
                    <div className="fixed inset-0 bg-black bg-opacity-80 z-50 flex justify-center items-center">
                        <div className="relative w-full h-full max-h-full max-w-full lg:max-w-[95%]">
                            <button
                                id={"close"}
                            ...
                            >
                                {[{
                                    ...
                                    <SwiperSlide key={index} className="flex justify-center items-center w-full h-full"
                                        ...
                                        {/* Text outside zoom container */}
                                        <div
                                            className="absolute bottom-4 left-4 text-white bg-black bg-opacity-60 p-2 rounded z-20 img-text">
                                            {imgObj.text}
                                        </div>
                                    </SwiperSlide>
                                ))}
